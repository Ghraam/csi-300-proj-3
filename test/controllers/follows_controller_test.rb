...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference("Follow.count") do
      post follows_url, params: { follow: { followee: @follow.followee, follower: @follow.follower } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { followee: @follow.followee, follower: @follow.follower } }
